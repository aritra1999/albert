...
<div class="flex justify-between items-center px-3 py-6 h-24 fixed top-0 container z-20">
    <input class="rounded-full px-4 py-3 border-none bg-transparent bg-white text-md font-medium z-20" type="date" on:change={updateEvents} bind:value={localeDateString}>
...
<div class="bg-white p-3 sm:p-6 md:p-12 rounded-b rounded-3xl min-h-screen mt-24 z-40">
